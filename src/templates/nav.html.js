export const NAV_TEMPLATE = /* HTML */ `
    <img src="assets/logo.svg" alt="0️⃣1️⃣">
    <h1>Welcome to Graph01</h1>
    <button>
        <?xml version="1.0" encoding="utf-8"?>
        <svg version="1.1" id="logout" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="50px" height="50px" viewBox="0 0 122.88 114.318" enable-background="new 0 0 122.88 114.318" xml:space="preserve" preserveAspectRatio="xMidYMid meet">
            <g>
