export const NAV_TEMPLATE = /* HTML */ `
    ...
    <button>
        ...
        <svg version="1.1" id="logout" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="40px" height="40px" viewBox="0 0 122.88 114.318" enable-background="new 0 0 122.88 114.318" xml:space="preserve" preserveAspectRatio="xMidYMid meet">
            <g>
